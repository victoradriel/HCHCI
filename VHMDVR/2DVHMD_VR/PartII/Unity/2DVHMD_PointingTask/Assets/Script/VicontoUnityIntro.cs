...
public class VicontoUnityIntro : MonoBehaviour {
    int userID = 1;

    GameObject[] Target = new GameObject[10];
    string[] targetnames = new string[] { "C6L2", "C2L2", "C10L2", "C6L1", "C6L4", "C6L3", "C2L1", "C4L3", "C8L2", "C10L4" };
    ...
    private void GetAzmVectors() {
        ...
        switch (trgtinfo[1]) {
            case "1":
                ...
                break;
            case "2":
                vecTrgtAZM = new Vector3(-6f, 0f, 0f);
                break;
            case "3":
                vecTrgtAZM = new Vector3(-4.988818f, 0f, 3.333421f);
                break;
            case "4":
                vecTrgtAZM = new Vector3(-4.24264f, 0f, 4.24264f);
                break;
            case "5":
                vecTrgtAZM = new Vector3(-1.170542f, 0f, 5.884711f);
                break;
            case "6":
                vecTrgtAZM = new Vector3(0f, 0f, 6f);
                break;
            case "7":
                vecTrgtAZM = new Vector3(3.333421f, 0f, 4.988818f);
                break;
            case "8":
                vecTrgtAZM = new Vector3(4.242641f, 0f, 4.242641f);
                break;
            case "9":
