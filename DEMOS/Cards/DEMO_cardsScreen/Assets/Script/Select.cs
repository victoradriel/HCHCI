...
public class Select : MonoBehaviour {
    ...
    void Start () {
        ...
        Cards[0] = GameObject.Find("CardJoker");
        Cards[1] = GameObject.Find("CardJ");
        Cards[2] = GameObject.Find("CardQ");
    ...
    void RotateCard() {
        ...
        switch (lastSelected) {
            case 0:
                Cards[0].transform.rotation = Quaternion.Slerp(Quaternion.Euler(0, 45, 0), Quaternion.Euler(0, 225, 0), t); //Time.time * t
            ...
            case 3:
                ...
                break;
            case 4:
                Cards[4].transform.rotation = Quaternion.Slerp(Quaternion.Euler(0, 315, 0), Quaternion.Euler(0, 135, 0), t);
                break;
        }
    }
    ...
    void Update () {
        ...
        if (Physics.Raycast(transform.position, transform.TransformDirection(direction), out hit)) {
            if (hit.collider.name == "CardJoker")
                SelectCard(0);
            else if (hit.collider.name == "CardJ")
                SelectCard(1);
            else if (hit.collider.name == "CardQ")
                SelectCard(2);
