                    ...
                    if (Console.KeyAvailable) {
                        ...
                        if (cki.Key == ConsoleKey.O && thisp.enableSound) {
                            switch (soundid) {
                                case 1:
                                    soundid = 5;
                                    player = new System.Media.SoundPlayer(@"C:\Users\victo\Documents\audioVicon\audio5.wav");
                                    Console.WriteLine("Sound Five: 880Hz . 200ms beep . 800ms interval");
                                    if (thisp.enableSound) player.Load();
                                    break;
                                case 2:
                                    soundid = 1;
                                    player = new System.Media.SoundPlayer(@"C:\Users\victo\Documents\audioVicon\audio1.wav");
                                    Console.WriteLine("Sound One: 880Hz . 200ms beep . 800ms interval");
                                    if (thisp.enableSound) player.Load();
                                    break;
                                case 3:
                                    soundid = 2;
                                    player = new System.Media.SoundPlayer(@"C:\Users\victo\Documents\audioVicon\audio2.wav");
                                    Console.WriteLine("Sound Two: 880Hz . 200ms beep . 800ms interval");
                                    if (thisp.enableSound) player.Load();
                                    break;
                                case 4:
                                    soundid = 3;
                                    player = new System.Media.SoundPlayer(@"C:\Users\victo\Documents\audioVicon\audio3.wav");
                                    Console.WriteLine("Sound Three: 880Hz . 200ms beep . 800ms interval");
                                    if (thisp.enableSound) player.Load();
                                    break;
                                case 5:
                                    soundid = 4;
                                    player = new System.Media.SoundPlayer(@"C:\Users\victo\Documents\audioVicon\audio4.wav");
