...
public class WoZ : MonoBehaviour {
	...
	static string[] SpMotors = new string[] {"Motor5","Motor6","Motor7","Motor8","Motor1","Motor2","Motor3","Motor4"};
	static string[] UpViewMtrs = new string[] {"UMotor5","UMotor6","UMotor7","UMotor8","UMotor1","UMotor2","UMotor3","UMotor4"};
	public static int[] MotorPosition = new int[] {8,10,12,14,0,2,4,6};
