...
function setPhoneLayout() {
	...
	if (moveTouchpad) {
			...
			moveTouchpad.gameObject.SetActive(true);
	    #endif
		...
		if (movePadPosition == controlPos.left) {
			...
			#endif
			#if UNITY_4_0 || UNITY_4_1
				moveTouchpad.gameObject.SetActive(false);
	    	#endif
		}
		moveTouchpad.setUp();
	}
	if (turnTouchpad) {
	    ...
	    #endif
		#if UNITY_4_0 || UNITY_4_1
			turnTouchpad.gameObject.SetActive(true);
	    #endif
		...
		if (turnPadPosition == controlPos.left) {
		    ...
		    #endif
			#if UNITY_4_0 || UNITY_4_1
				turnTouchpad.gameObject.SetActive(false);
		    #endif
		}
		turnTouchpad.setUp();
	}
	if (pointTouchpad) {
	   ...
	   #endif
		#if UNITY_4_0 || UNITY_4_1
			pointTouchpad.gameObject.SetActive(true);
	    #endif
		...
		if (pointPadPosition == controlPos.left) {
		    ...
		    #endif
			#if UNITY_4_0 || UNITY_4_1
				pointTouchpad.gameObject.SetActive(false);
		    #endif
		}
		pointTouchpad.setUp();
	}
	...
	if (stereoParamsTouchpad) {
		if (useStereoParamsTouchpad) {
		    ...
		    #endif
			#if UNITY_4_0 || UNITY_4_1
				stereoParamsTouchpad.gameObject.SetActive(true);
		    #endif
		    ...
		    #endif
			#if UNITY_4_0 || UNITY_4_1
				stereoParamsTouchpad.gameObject.SetActive(false);
		    #endif
		}
	}
	...
	if (loadNewSceneTouchpad) {
		if (showLoadNewScenePad) {
		    ...
		    #endif
			#if UNITY_4_0 || UNITY_4_1
				loadNewSceneTouchpad.gameObject.SetActive(true);
		    #endif
		    ...
		    #endif
			#if UNITY_4_0 || UNITY_4_1
				loadNewSceneTouchpad.gameObject.SetActive(false);
		    #endif
		}
	}
	...
	if (fpsTool01) {
		if (showFpsTool01) {
		    ...
		    #endif
			#if UNITY_4_0 || UNITY_4_1
				fpsTool01.gameObject.SetActive(true);
		    #endif	
		    ...
		    #endif
			#if UNITY_4_0 || UNITY_4_1
				fpsTool01.gameObject.SetActive(false);
		    #endif
		}
	}
	...
	if (fpsTool02) {
		if (showFpsTool02) {
		    ...
		    #endif
			#if UNITY_4_0 || UNITY_4_1
				fpsTool02.gameObject.SetActive(true);
		    #endif
		    ...
		    #endif
			#if UNITY_4_0 || UNITY_4_1
				fpsTool02.gameObject.SetActive(false);
		    #endif	
		}
	}
